    ...
    <div class="row ">
        ...
        <div class="col-md-6 mt-4 mb-3 d-flex justify-content-end">
              ...
              <form  action="<?php echo e(route('buku.search')); ?>" method="get" class="navbar-search navbar-search-light form-inline mr-sm-3 " id="navbar-search-main">
                ...
                <input type="text" placeholder="masukkan pencarian" class="form-control bg-white <?php $__errorArgs = ['q'];
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\Laravel\perpustakaan_laravel-main\resources\views/buku/index.blade.php ENDPATH**/ ?>